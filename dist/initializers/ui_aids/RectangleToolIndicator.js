...
export class RectToolIndicator {
    ...
    resizeIndicator(x, y, deltaX, deltaY, ctx) {
        ...
        ctx.beginPath();
        ctx.fillStyle = "red";
        ctx.arc((_c = this.anchorX) !== null && _c !== void 0 ? _c : x, (_d = this.anchorY) !== null && _d !== void 0 ? _d : y, 1, 0, 2 * Math.PI);
        ctx.fill();
        ctx.beginPath();
        ctx.fillStyle = "blue";
        ctx.arc(newX, newY, 1, 0, 2 * Math.PI);
        ctx.fill();
        this.divElement.style.width = `${Math.abs(((_e = this.anchorX) !== null && _e !== void 0 ? _e : x) - x)}px`;
        this.divElement.style.height = `${Math.abs(((_f = this.anchorY) !== null && _f !== void 0 ? _f : y) - y)}px`;
        this.deltaX = deltaX;
        this.deltaY = deltaY;
    }
    isIndicatorVisible() {
